...
const Accomodation = ({showModal,setShowModal}:any) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row items-center justify-evenly bg-gray-100 p-8 rounded-lg">
        <div className="lg:w-1/2 mb-8 lg:mb-0">
          <h2 className="text-5xl font-bold mb-4">Find suitable budget accommodation</h2>
        ...
        <div className=" flex flex-col items-center lg:items-start relative">
          ...
          <motion.div className="bg-white absolute bottom-0 left-0 translate-x-[-50%] translate-y-[-50%] shadow-xl shadow-gray-500 p-4 rounded-lg"
      ...
      >
        <div
          className="relative bg-white rounded-lg p-4 max-w-5xl w-full h-72 items-center justify-start flex flex-col gap-20"
