...
import AppPlaceCard from '../_components/PlaceCard';
      ...
      >
        ...
        >
          ...
          <div className="mb-4 space-x-1 space-y-2 text-gray-400 md:space-x-2 lg:mb-8">
            {Object.keys(RoomType).map((room) => {
              return <button className="px-2 py-1 text-xs duration-300 border border-gray-500 border-opacity-50 rounded-full cursor-pointer md:px-4 md:py-2 lg:text-sm active:scale-90 hover:border-gray-500">
                {room}
              </button>
            })}
