...
const SearchPage = () => {
  ...
  const { data } = api.room.getRoomsByGuestHouse.useQuery(
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <main className="grid grid-cols-1 duration-500">
        ...
        <div className="px-4 py-8 duration-500 lg:py-12 lg:px-7">
          <span className="inline-block mb-2 text-2xl text-gray-500">
