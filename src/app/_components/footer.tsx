      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="border-t border-gray-200 py-20">
          <div className="grid grid-cols-1 md:grid-flow-col md:auto-rows-min md:grid-cols-12 md:gap-x-8 md:gap-y-16">
            ...
            <div className="mt-12 md:col-span-8 md:col-start-3 md:row-start-2 md:mt-0 lg:col-span-4 lg:col-start-1 lg:row-start-1  justify-center items-center flex flex-col gap-4">
              <h1 className="text-5xl font-medium text-gray-900">
                LOGO
              </h1>
              <div className='flex gap-2'><Button>App Store</Button><Button>Play Store</Button></div>
            </div>
